...
//     //     {
//     //       if(select === "total"){
//     //         setRows(rows.sort((a,b) => (a.price *a.quantity> b.price *b.quantity) ? 1 : ((b.price *b.quantity > a.price *a.quantity) ? -1 : 0)))
//     //       }
//     //       else{
//     //           setRows(rows.sort((a,b) => (a[select]> b[select]) ? 1 : ((b[select] > a[select]) ? -1 : 0)))
//     //       }
//     //     }
//     //     //asc
//     //     else{
...
//       {
//         if(select === "total"){
//          rows.sort((a,b) => (a.price *a.quantity> b.price *b.quantity) ? 1 : ((b.price *b.quantity > a.price *a.quantity) ? -1 : 0))
//         }
//         else{
//           rows.sort((a,b) => (a[select]> b[select]) ? 1 : ((b[select] > a[select]) ? -1 : 0))
//         }
//         //return sortRows;
//       }
//       //asc
